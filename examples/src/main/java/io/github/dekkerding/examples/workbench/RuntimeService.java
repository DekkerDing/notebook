 ...
 */
package io.github.dekkerding.examples.workbench;

import io.github.dekkerding.examples.camunda.bpm.engine.authorization.BatchPermissions;
import io.github.dekkerding.examples.camunda.bpm.engine.authorization.ProcessDefinitionPermissions;
import io.github.dekkerding.examples.camunda.bpm.engine.authorization.ProcessInstancePermissions;
import io.github.dekkerding.examples.camunda.bpm.engine.batch.Batch;
import io.github.dekkerding.examples.camunda.bpm.engine.delegate.ExecutionListener;
import io.github.dekkerding.examples.camunda.bpm.engine.exception.AuthorizationException;
import io.github.dekkerding.examples.camunda.bpm.engine.exception.BadUserRequestException;
import io.github.dekkerding.examples.camunda.bpm.engine.exception.NotValidException;
import io.github.dekkerding.examples.camunda.bpm.engine.exception.ProcessEngineException;
import io.github.dekkerding.examples.camunda.bpm.engine.history.HistoricProcessInstanceQuery;
import io.github.dekkerding.examples.camunda.bpm.engine.repository.ProcessDefinition;
import io.github.dekkerding.examples.camunda.bpm.engine.runtime.*;
...
/** Service which provides access to {@link io.github.dekkerding.examples.camunda.bpm.engine.repository.Deployment}s,
...
public interface RuntimeService {
   ...
   *          if the user has no {@link io.github.dekkerding.examples.camunda.bpm.engine.authorization.Permissions#CREATE} permission on {@link io.github.dekkerding.examples.camunda.bpm.engine.authorization.Resources#PROCESS_INSTANCE}
   *          and no {@link io.github.dekkerding.examples.camunda.bpm.engine.authorization.Permissions#CREATE_INSTANCE} permission on {@link io.github.dekkerding.examples.camunda.bpm.engine.authorization.Resources#PROCESS_DEFINITION}.
   */
   ...
   *
   * @throws io.github.dekkerding.examples.camunda.bpm.engine.exception.BadUserRequestException
   *          when the processInstanceId is null.
   * @throws io.github.dekkerding.examples.camunda.bpm.engine.exception.NotFoundException
   *          when no process instance is found with the given processInstanceId.
   * @throws AuthorizationException
   *          if the user has no {@link io.github.dekkerding.examples.camunda.bpm.engine.authorization.Permissions#DELETE} permission on {@link io.github.dekkerding.examples.camunda.bpm.engine.authorization.Resources#PROCESS_INSTANCE}
   *          or no {@link io.github.dekkerding.examples.camunda.bpm.engine.authorization.Permissions#DELETE_INSTANCE} permission on {@link io.github.dekkerding.examples.camunda.bpm.engine.authorization.Resources#PROCESS_DEFINITION}.
   */
   ...
   * @throws AuthorizationException
   *          If the user has no {@link io.github.dekkerding.examples.camunda.bpm.engine.authorization.Permissions#CREATE} or
   *          {@link BatchPermissions#CREATE_BATCH_DELETE_RUNNING_PROCESS_INSTANCES} permission on {@link io.github.dekkerding.examples.camunda.bpm.engine.authorization.Resources#BATCH}.
   */
   ...
   * @throws AuthorizationException
   *          if the user has no {@link io.github.dekkerding.examples.camunda.bpm.engine.authorization.Permissions#READ} permission on {@link io.github.dekkerding.examples.camunda.bpm.engine.authorization.Resources#PROCESS_INSTANCE}
   *          or no {@link io.github.dekkerding.examples.camunda.bpm.engine.authorization.Permissions#READ_INSTANCE} permission on {@link io.github.dekkerding.examples.camunda.bpm.engine.authorization.Resources#PROCESS_DEFINITION}.
   */
   ...
   * @throws AuthorizationException
   *          if the user has no {@link io.github.dekkerding.examples.camunda.bpm.engine.authorization.Permissions#UPDATE} permission on {@link io.github.dekkerding.examples.camunda.bpm.engine.authorization.Resources#PROCESS_INSTANCE}
   *          or no {@link io.github.dekkerding.examples.camunda.bpm.engine.authorization.Permissions#UPDATE_INSTANCE} permission on {@link io.github.dekkerding.examples.camunda.bpm.engine.authorization.Resources#PROCESS_DEFINITION}.
   */
   ...
   *          when no execution is found for the given executionId.
   * @throws AuthorizationException
   *          <li>if the user has no {@link io.github.dekkerding.examples.camunda.bpm.engine.authorization.Permissions#READ} permission on {@link io.github.dekkerding.examples.camunda.bpm.engine.authorization.Resources#PROCESS_INSTANCE} or
   *          no {@link io.github.dekkerding.examples.camunda.bpm.engine.authorization.Permissions#READ_INSTANCE} permission on {@link io.github.dekkerding.examples.camunda.bpm.engine.authorization.Resources#PROCESS_DEFINITION}</li>
   *          <li> In case {@link io.github.dekkerding.examples.camunda.bpm.engine.authorization.ProcessEngineConfiguration#enforceSpecificVariablePermission this} config is enabled and
   ...
   *          <li>if the user has no {@link io.github.dekkerding.examples.camunda.bpm.engine.authorization.Permissions#READ} permission on {@link io.github.dekkerding.examples.camunda.bpm.engine.authorization.Resources#PROCESS_INSTANCE} or
   *          no {@link io.github.dekkerding.examples.camunda.bpm.engine.authorization.Permissions#READ_INSTANCE} permission on {@link io.github.dekkerding.examples.camunda.bpm.engine.authorization.Resources#PROCESS_DEFINITION}</li>
   *          <li> In case {@link io.github.dekkerding.examples.camunda.bpm.engine.runtime.ProcessEngineConfiguration#enforceSpecificVariablePermission this} config is enabled and
   *          the user has no {@link ProcessDefinitionPermisions#READ_INSTANCE_VARIABLE} permission on {@link Resources#PROCESS_DEFINITION}</li>
   */
   ...
   *          <li>if the user has no {@link io.github.dekkerding.examples.camunda.bpm.engine.authorization.Permissions#READ} permission on {@link io.github.dekkerding.examples.camunda.bpm.engine.authorization.Resources#PROCESS_INSTANCE} or
   *          no {@link io.github.dekkerding.examples.camunda.bpm.engine.authorization.Permissions#READ_INSTANCE} permission on {@link io.github.dekkerding.examples.camunda.bpm.engine.authorization.Resources#PROCESS_DEFINITION}</li>
   *          <li> In case {@link io.github.dekkerding.examples.camunda.bpm.engine.runtime.ProcessEngineConfiguration#io.github.dekkerding.examples.camunda.bpm.engine.runtime.ProcessEngineConfiguration.enforceSpecificVariablePermission this} config is enabled and
   *          the user has no {@link ProcessDefinitionPermisions#READ_INSTANCE_VARIABLE} permission on {@link Resources#PROCESS_DEFINITION}</li>
   *
   * @since 7.2
   *
   ...
   *          no {@link io.github.dekkerding.examples.camunda.bpm.engine.authorization.Permissions#READ_INSTANCE} permission on {@link io.github.dekkerding.examples.camunda.bpm.engine.authorization.Resources#PROCESS_DEFINITION}</li>
   *          <li> In case {@link io.github.dekkerding.examples.camunda.bpm.engine.runtime.ProcessEngineConfiguration#enforceSpecificVariablePermission this} config is enabled and
   *          the user has no {@link ProcessDefinitionPermisions#READ_INSTANCE_VARIABLE} permission on {@link io.github.dekkerding.examples.camunda.bpm.engine.authorization.Resources#PROCESS_DEFINITION}</li>
   *
   * @since 7.2
   *
   */
   ...
   *          <li>{@link io.github.dekkerding.examples.camunda.bpm.engine.authorization.ProcessInstancePermissions#UPDATE_VARIABLE} permission on {@link io.github.dekkerding.examples.camunda.bpm.engine.authorization.Resources#PROCESS_INSTANCE}</li>
   *          <li>{@link io.github.dekkerding.examples.camunda.bpm.engine.authorization.ProcessDefinitionPermissions#UPDATE_INSTANCE_VARIABLE} permission on {@link io.github.dekkerding.examples.camunda.bpm.engine.authorization.Resources#PROCESS_DEFINITION}</li>
   *          <li>{@link io.github.dekkerding.examples.camunda.bpm.engine.authorization.Permissions#UPDATE} permission on {@link io.github.dekkerding.examples.camunda.bpm.engine.authorization.Resources#PROCESS_INSTANCE}</li>
   *          <li>{@link io.github.dekkerding.examples.camunda.bpm.engine.authorization.Permissions#UPDATE_INSTANCE} permission on {@link io.github.dekkerding.examples.camunda.bpm.engine.authorization.Resources#PROCESS_DEFINITION}</li>
   */
   ...
   * {@link BatchPermissions#CREATE_BATCH_SET_VARIABLES} permission on {@link io.github.dekkerding.examples.camunda.bpm.engine.authorization.Resources#BATCH}.
   *
   ...
   * </ul>
   * @throws ProcessEngineException when the java serialization format is prohibited
   * @throws AuthorizationException when the user has no {@link Batchio.github.dekkerding.examples.camunda.bpm.engine.authorization.Permissions#CREATE} or
   * {@link BatchPermissions#CREATE_BATCH_SET_VARIABLES} permission on {@link io.github.dekkerding.examples.camunda.bpm.engine.authorization.Resources#BATCH}.
   *
   * @return the batch which sets the variables asynchronously.
   */
   ...
   * @throws AuthorizationException
   *          if the user has none of the following:
   *          <li>{@link ProcessInstancePermissions#UPDATE_VARIABLE} permission on {@link io.github.dekkerding.examples.camunda.bpm.engine.authorization.Resources#PROCESS_INSTANCE}</li>
   *          <li>{@link ProcessDefinitionPermissions#UPDATE_INSTANCE_VARIABLE} permission on {@link io.github.dekkerding.examples.camunda.bpm.engine.authorization.Resources#PROCESS_DEFINITION}</li>
   *          <li>{@link io.github.dekkerding.examples.camunda.bpm.engine.authorization.Permissions#UPDATE} permission on {@link io.github.dekkerding.examples.camunda.bpm.engine.authorization.Resources#PROCESS_INSTANCE}</li>
   *          <li>{@link io.github.dekkerding.examples.camunda.bpm.engine.authorization.Permissions#UPDATE_INSTANCE} permission on {@link io.github.dekkerding.examples.camunda.bpm.engine.authorization.Resources#PROCESS_DEFINITION}</li>
   */
   ...
   * @throws AuthorizationException
   *          if the user has none of the following:
   *          <li>{@link ProcessInstancePermissions#SUSPEND} permission on {@link io.github.dekkerding.examples.camunda.bpm.engine.authorization.Resources#PROCESS_INSTANCE}</li>
   *          <li>{@link ProcessDefinitionPermissions#SUSPEND_INSTANCE} permission on {@link io.github.dekkerding.examples.camunda.bpm.engine.authorization.Resources#PROCESS_DEFINITION}</li>
   *          <li>{@link io.github.dekkerding.examples.camunda.bpm.engine.authorization.Permissions#UPDATE} permission on {@link io.github.dekkerding.examples.camunda.bpm.engine.authorization.Resources#PROCESS_INSTANCE}</li>
   *          <li>{@link io.github.dekkerding.examples.camunda.bpm.engine.authorization.Permissions#UPDATE_INSTANCE} permission on {@link io.github.dekkerding.examples.camunda.bpm.engine.authorization.Resources#PROCESS_DEFINITION}</li>
   */
   ...
   *
   * @throws AuthorizationException
   *          <li>if notify an execution and the user has no {@link io.github.dekkerding.examples.camunda.bpm.engine.authorization.Permissions#UPDATE} permission on {@link io.github.dekkerding.examples.camunda.bpm.engine.authorization.Resources#PROCESS_INSTANCE}
   *          or no {@link io.github.dekkerding.examples.camunda.bpm.engine.authorization.Permissions#UPDATE_INSTANCE} permission on {@link io.github.dekkerding.examples.camunda.bpm.engine.authorization.Resources#PROCESS_DEFINITION}.</li>
   *          <li>if start a new process instance and the user has no {@link io.github.dekkerding.examples.camunda.bpm.engine.authorization.Permissions#CREATE} permission on {@link io.github.dekkerding.examples.camunda.bpm.engine.authorization.Resources#PROCESS_INSTANCE}
   *          and no {@link io.github.dekkerding.examples.camunda.bpm.engine.authorization.Permissions#CREATE_INSTANCE} permission on {@link io.github.dekkerding.examples.camunda.bpm.engine.authorization.Resources#PROCESS_DEFINITION}.</li>
   */
   ...
   *     <ul>
   *       <li>{@link io.github.dekkerding.examples.camunda.bpm.engine.authorization.Permissions#CREATE} permission on {@link io.github.dekkerding.examples.camunda.bpm.engine.authorization.Resources#PROCESS_INSTANCE}</li>
   *       <li>{@link io.github.dekkerding.examples.camunda.bpm.engine.authorization.Permissions#CREATE_INSTANCE} permission on {@link io.github.dekkerding.examples.camunda.bpm.engine.authorization.Resources#PROCESS_DEFINITION}</li>
   *       <li>{@link io.github.dekkerding.examples.camunda.bpm.engine.authorization.Permissions#READ_HISTORY} permission on {@link io.github.dekkerding.examples.camunda.bpm.engine.authorization.Resources#PROCESS_DEFINITION}</li>
   *     </ul>
   */
   ...
   * @throws AuthorizationException
   *          if the user has no {@link io.github.dekkerding.examples.camunda.bpm.engine.authorization.Permissions#UPDATE} permission on {@link io.github.dekkerding.examples.camunda.bpm.engine.authorization.Resources#PROCESS_INSTANCE}
   *          and no {@link io.github.dekkerding.examples.camunda.bpm.engine.authorization.Permissions#UPDATE_INSTANCE} permission on {@link io.github.dekkerding.examples.camunda.bpm.engine.authorization.Resources#PROCESS_DEFINITION}.
   */
